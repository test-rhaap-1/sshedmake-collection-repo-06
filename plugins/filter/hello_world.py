"""A hello-world filter plugin in sshedmake_namespace_06.myrhdh_06."""
...
DOCUMENTATION = """
    name: hello_world
    author: Sshedmake_namespace_06 Myrhdh_06
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | sshedmake_namespace_06.myrhdh_06.hello_world }}"
"""
